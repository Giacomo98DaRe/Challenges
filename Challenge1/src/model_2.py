...
# %%
val_gen = val_data_gen.flow_from_directory(directory=dataset_dir,
                                           target_size=(256,256),
                                           color_mode='rgb',
                                           classes=None, # can be set to labels
                                           class_mode='categorical',
...
# %%
first_model = build_model(input_shape)
first_model.summary()
...
# %%
# callbacks = create_folders_and_callbacks(model_name = "model_less_tomato_v1")

standard_history = first_model.fit(
    x = train_gen,
